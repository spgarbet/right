...
- DOI: 10.7326/M13-1999
  ...
  issued:
    ...
    year: 2014
  page: 221-32
  title: Cost-effectiveness of genotype-guided and dual antiplatelet therapies in
...
Solution of the Dual Antiplatelet Therapy (DAPT) model in a fast format is required for delivery of AIM III of RIGHT grant. This report details the method of the solution in R. The code is then translated into Julia for quick model execution over a defined parameter space for probability sensitivity analysis.
...
TBD NEED TABLE OF PARAMETERS

## Cornerstone Equations

TBD SHOW EXPONENTIAL DEFINITION HERE
...
The cornerstone equations is a piecewise exponential loss functions with a rate specified for
each phase, pasted together.
...
Validation of numerical accuracy. Given that the age solutions should account for 100\% of the population in that an individual is neither created or destroyed we can check the accuracy of this constraint.
...
This shows acceptable total error in the numerical solution.
