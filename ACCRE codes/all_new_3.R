...
save(summ,file=paste0("~gravesj/data/right/sum_all_new_",num_seed,"_3.rda"))
...
save(out,file=paste0("~gravesj/data/right/cost_all_new_",num_seed,"_3.rda"))
...
#warfarin
save(warfarin,file=paste0("~gravesj/data/right/wa_all_new_",num_seed,"_3.rda"))
